<template>
  <b-sidebar
    v-if="fetchedBookMarkDealIndex != null"
    bg-variant="gray"
    id="sidebar-ateention-detail"
    shadow
  >
    <div class="container-fulid">
      <div class="text-center" style="padding-top:5rem;">
        <b-spinner variant="danger" label="Loading..."></b-spinner>
        <p class="mt-3" style="font-size:0.8rem;font-weight:500">
          이미지 로딩중
        </p>
      </div>
        ...
        <div class="row">
          <div class="col-md-11 ml-3 py-0">
            <span
              ...
              style="color:#000;font-weight:500;font-size:1.1rem;"
              >아파트 정보</span
            ><font-awesome-icon
              class="mt-1"
              icon="chevron-right"
        ...
        <b-collapse visible id="area1">
          <div class="row mt-3">
            <div class="col-lg-12 px-4">
              ...
              >
                {{ fetchedBookMarkDeals[fetchedBookMarkDealIndex].aptName }}
              </div>
            </div>
            <!-- 완공 일자-->
            <div class="col-lg-12 px-4">
              ...
              >
                {{ fetchedBookMarkDeals[fetchedBookMarkDealIndex].buildYear }}년
                완공
              </div>
            </div>
          </div>
          <!-- 거래정보  -->
          <div v-if="fetchedBookMarkDeals != null" class="row mt-3">
            <div class="col-lg-12 px-4">
              <!--collapse -->
              <div>
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-9 px-4 my-1 detailValue">
                    {{ fetchedBookMarkDeals[fetchedBookMarkDealIndex].dong }}
                    {{ fetchedBookMarkDeals[fetchedBookMarkDealIndex].jibun }}
                  </div>
                </div>
                <hr class="style4 my-1" />
                <!-- 층수  -->
                <div class="row">
                  ...
                  <div class="col-md-9 px-4 my-1 detailValue">
                    {{ fetchedBookMarkDeals[fetchedBookMarkDealIndex].floor }}층
                  </div>
                </div>
                <hr class="style4 my-1" />
                ...
                <!--전용 면적 -->
                <div class="row">
                  <div class="col-md-3 px-4 my-1 detailKey">면적(㎡)</div>
                  <div class="col-md-9 px-4 my-1 detailValue">
                    {{ fetchedBookMarkDeals[fetchedBookMarkDealIndex].area }}㎡
                  </div>
                </div>
                <hr class="style4 my-1" />
                <!--거래 일자 -->
                <div class="row">
                  ...
                  <div class="col-md-9 px-4 my-1 detailValue">
                    {{
                      fetchedBookMarkDeals[fetchedBookMarkDealIndex].dealYear
                    }}년
                    {{
                      fetchedBookMarkDeals[fetchedBookMarkDealIndex].dealMonth
                    }}월
                    {{
                      fetchedBookMarkDeals[fetchedBookMarkDealIndex].dealDay
                    }}일
                  </div>
                </div>
              </div>
      ...
      <div class="Inforow mt-3 py-3" v-b-toggle.area2>
        <!--탭 부분 -->
        <div class="row">
      ...
      <div class="Inforow mt-3" v-b-toggle.area3>
        <!--탭 부분 -->
        <div class="row pt-2">
